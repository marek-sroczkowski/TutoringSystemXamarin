...
using TutoringSystemMobile.ViewModels.ReportViewModels;
using Xamarin.Forms;
...
namespace TutoringSystemMobile.Views
{
    ...
    public partial class ReportFilteringPopupPage
    {
        public ReportFilteringPopupPage(ReportFilteringDto reportFiltering)
        {
            InitializeComponent();
            BindingContext = new ReportFilteringViewModel(reportFiltering);
        }
